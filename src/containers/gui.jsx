...
const mapStateToProps = state => {
    ...
    return {
        ...
        tabSwitchModalVisible: state.scratchGui.modals.tabSwitchModal,
...
const mapDispatchToProps = dispatch => ({
    ...
    onActivateTab: (tab, currentTab) => {
        // Check if switching from Text Programming (Arduino tab) to Code tab
        if (currentTab === ARDUINO_TAB_INDEX && tab === BLOCKS_TAB_INDEX) {
            // Show modal instead of switching immediately
            dispatch(openTabSwitchModal());
            return;
        }
        // Normal tab switch
